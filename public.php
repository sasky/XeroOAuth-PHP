...
if (XRO_APP_TYPE == 'Partner') {
    $signatures['curl_ssl_cert'] = XERO_BASE_PATH . '/certs/entrust-cert-RQ3.pem';
    $signatures['curl_ssl_password'] = '1234';
    $signatures['curl_ssl_key'] = XERO_BASE_PATH . '/certs/entrust-private-RQ3.pem';
}

$XeroOAuth = new XeroOAuth(array_merge([
...
if ($checkErrors > 0) {
    ...
    if (isset($_REQUEST['oauth_verifier'])) {
        ...
        $code = $XeroOAuth->request('GET', $XeroOAuth->url('AccessToken', ''), [
